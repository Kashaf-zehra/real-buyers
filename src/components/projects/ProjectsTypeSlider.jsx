...
const ProjectsTypeSlider = ({ data, category, type }) => {
  ...
  return (
    <Swiper {...sliderSettings}>
      {filteredData?.slice(0, totalItems).map((project) => (
        <SwiperSlide key={project?.property_id}>
          <Grid
            container
            sx={{
              display: 'flex',
...
export default ProjectsTypeSlider;
